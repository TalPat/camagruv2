<?php
	...
	if ($email != "" && isset($_POST['okay']) && $username != "") {
		...
		if (mail($_POST['email'], "Do not reply", "Click on the link to change your password <br>http://localhost:8080/updatepassword.php?id=$username&code=".$refcode.", From: tpatter@student.wethinkcode.co.za"))
